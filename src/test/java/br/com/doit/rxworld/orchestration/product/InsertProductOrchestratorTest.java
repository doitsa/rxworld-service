...
public class InsertProductOrchestratorTest {
	...
	@Test
	@Timeout(4)
	void insertRxWorldProductWhenReceivingCommand() throws InterruptedException {
		...
		assertThat(productReference.dateCreated, is(Date.valueOf(now().toString())));
		assertThat(productReference.dateUpdated, is(Date.valueOf(now().toString())));
		assertThat(productReference.doitProductId, is(123));
		assertThat(productReference.sku, is("SAMPLE01"));
		assertThat(productReference.webStore.doitWebStoreId, is(1));
	}
	
	@Test
	@Timeout(4)
	void doNotInsertRxWorldProductWhenWebStoreIsNotFound() throws InterruptedException {
	...
	@Test
	@Timeout(4)
	void doNotInsertRxWorldProductWhenSomethingIsWrongOnJsonBody() throws InterruptedException {
